...
with open("OP20190256AU_국문명세서.docx", "rb") as docx_file:
...
with open("./pdf/OP20190256AU_국문명세서.pdf", "rb") as f:
    pdf = pdftotext.PDF(f)
...
pure_main_footer = del_header(pdfToken, "【기술분야】")
